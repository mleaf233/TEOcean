return {
    ...
    descriptions = {
        glyphs = {
            c_abn_exile = {
                name = "流放",
                text = {
                    "将{V:1}#2#{}添加到{C:attention}#1#张选定手牌中",
                },
            },
            c_abn_impure = {
                name = "不洁",
        ...
        calligraphy = {
            ...
            c_abn_buky = {
                ...
                text = {
                    ...
                    "转化为{V:1}#1#{}的{C:attention}金色{C:attention}A{}",
                },
            },
            c_abn_vede = {
                name = "Vede",
                text = {
                    "将手牌中{C:attention}最右侧{}的牌",
                    "转化为{C:attention}山脉{} {V:1}#1#{}牌",
                },
            },
            c_abn_ghe = {
                name = "Ghe",
                text = {
                    "将手牌中{C:attention}最左侧{}牌的点数降低{C:attention}2",
                },
            },
            c_abn_de = {
                name = "De",
            ...
            c_abn_ye = {
                ...
                text = {
                    "将手牌中{C:attention}最左侧{}的牌",
                    "转化为{V:1}#1#{}的{C:attention}金缮{C:attention}4{}",
                },
            },
            c_abn_yo = {
                name = "Yo",
                text = {
                    "将手牌中{C:attention}最左侧{}的牌",
                    "转化为{V:1}#1#{}的{C:attention}玻璃{C:attention}13{}",
                },
            },
            c_abn_zhe = {
                name = "Zhe",
                text = {
                    "将手牌中{C:attention}最右侧{}的牌",
                    "转化为{V:1}#1#{}的{C:attention}壁纸{C:attention}10{}",
                },
            },
            c_abn_ze = {
                name = "Ze",
                text = {
                    "将手牌中{C:attention}最左侧{}的牌",
                    "转化为{V:1}#1#{}的{C:attention}加固{C:attention}12{}",
                },
            },
            c_abn_i_cal = {
                name = "I",
            ...
            c_abn_em = {
                ...
                text = {
                    "将手牌中{C:attention}最左侧{}的牌",
                    "转化为{V:1}#1#{}的{C:attention}禅{C:attention}8{}",
                },
            },
            c_abn_en = {
                name = "En",
                text = {
                    "将手牌中{C:attention}最右侧{}的牌",
                    "转化为{V:1}#1#{}的{C:attention}山脉{C:attention}A{}",
                },
            },
            c_abn_o_cal = {
                name = "O",
                text = {
                    "手牌中{C:attention}最左侧{}的牌",
                    "如果点数低于{C:attention}5",
                    "永久获得其点数{C:attention}三倍{}的筹码",
                },
            },
            c_abn_pe = {
                name = "Pe",
            ...
            c_abn_dzelo = {
                ...
                text = {
                    "将手牌中所有牌的花色",
                    "变为{C:attention}最左侧{}牌的花色",
                    "并将其版本变为{C:attention}最左侧{}牌的版本",
                    "",
                    "将手牌中所有牌",
                    "增强为{C:attention}亲缘{}牌",
                },
            },
            c_abn_ize = {
                name = "Ize",
                text = {
                    "将手牌中所有牌",
                    "增强为{C:attention}壁纸{}牌",
                    "",
                    "如果{C:attention}最右侧{}的牌",
                    "带有{C:attention}蜡封{}",
                    "则将该{C:attention}蜡封{}复制到手牌中所有牌上",
                },
            },
            c_abn_oy = {
                name = "Oy",
                text = {
                    "将手牌中所有牌",
                    "转化为{V:1}#1#{}的",
                    "{C:dark_edition}亮光{}{C:attention}金色{C:attention}13{}",
                    "",
            ...
            c_abn_ot = {
                ...
                text = {
                    "将手牌中所有牌",
                    "转化为{C:attention}加固{} {V:1}#1#{}牌",
                    "",
                    "将{C:attention}最右侧{}小丑牌上的",
                    "所有{C:attention}贴纸{}复制到",
                    "其他所有小丑牌上",
                },
            },
            c_abn_yat = {
                ...
                text = {
                    "将手牌中所有牌",
                    "增强为{C:attention}海洋{}牌",
                    "",
                    "手牌中所有牌永久获得",
                    "等同于{C:attention}最左侧{}牌点数的倍率",
            ...
            c_abn_iya = {
                ...
                text = {
                    "将手牌中所有牌",
                    "增强为{C:attention}山脉{}牌",
                    "",
                    "手牌中所有牌永久获得",
                    "等同于{C:attention}最右侧{}牌点数",
                    "{C:attention}两倍{}的筹码",
        ...
        solid_state = {
            c_abn_digitization = {
                name = "数字化",
                text = {
                    "将{C:attention}1{}张选定{C:attention}小丑牌",
                    "替换为更高{C:attention}稀有度{}的小丑牌",
                    "资金变为{C:money}$-10{}",
            ...
            c_abn_paste = {
                name = "粘贴",
                text = {
                    "复制{C:attention}1{}张选定{C:attention}小丑牌",
                    "",
                    "给所有其他小丑牌",
                    "添加{C:inactive}易碎{}效果",
                },
            ...
            c_abn_bookmark = {
                name = "书签",
                text = {
                    "摧毁{C:attention}1{}张选定{C:attention}人头牌",
                    "生成{C:attention}3{}张随机",
                    "{C:attention}高点数数字牌",
                    "并带有随机{C:attention}蜡封{}",
                },
            },
            c_abn_translate = {
                name = "转译",
                text = {
                    "{C:green}重掷{}所有{C:attention}小丑牌",
                    "及其{C:dark_edition}版本{}",
                },
            },
            c_abn_incognito = {
                name = "隐身",
                text = {
                    "给手牌中所有牌添加",
                    "{C:attention}翻转{}和{C:abn_brown_seal}棕色蜡封{}",
                },
            },
            c_abn_upload = {
                name = "上传",
            ...
            c_abn_database = {
                name = "数据库",
                text = {
                    "摧毁{C:attention}1{}张选定{C:attention}小丑牌",
                    "选择一张相同",
                    "{C:attention}稀有度{}的新小丑牌",
                },
            },
            c_abn_zoom = {
                name = "缩放",
                text = {
                    "将手牌中所有牌的",
                    "{C:planet}星球{C:attention}点数{}等级提升{C:attention}2{}级",
                },
            },
            c_abn_recycle = {
                name = "回收",
                text = {
                    "摧毁手牌中选定的牌",
                    "获得等同于其{C:attention}点数{}的资金",
                },
            },
            c_abn_watch_later = {
                name = "稍后观看",
                text = {
                    "生成一张最后售出{C:attention}小丑牌的",
            ...
            c_abn_update = {
                name = "更新",
                text = {
                    "升级{C:attention}#1#{}张选定",
                    "牌的{C:dark_edition}版本{}",
                },
            },
            c_abn_bug = {
                name = "故障",
                text = {
                    "将选定{C:attention}小丑牌的",
                    "数值翻倍并添加{C:enhanced}故障{}效果",
                },
            },
            c_abn_chip = {
                name = "芯片",
                text = {
                    {
                        ...
                        "添加{C:abn_eternal}永恒{}和{C:dark_edition}镭射{}效果",
                        "给{C:attention}最右侧{}的小丑牌",
                        "添加{C:abn_eternal}永恒{}和{C:dark_edition}闪箔{}效果",
                        "并将二者移入{C:attention}消耗牌区域{}",
                    },
                    {
                        "{C:red}-1{}商店槽位",
                        "每回合{C:red}-1{}次出牌",
        ...
        program_pack = {
            c_abn_png = {
                ...
                text = {
                    ...
                    "增强为{C:dark_edition}负片{}{C:attention}幸运牌{}",
                }
            },
            c_abn_mp4 = {
                name = ".MP4",
                text = {
                    "将手牌中{C:attention}#1#{}张随机牌",
                    "增强为{C:dark_edition}亮光{}{C:attention}奖励牌{}",
                    "{C:red}摧毁{}所有其他牌",
                }
            },
            c_abn_exe = {
                ...
                text = {
                    {
                        "{s:0.8}将手中的{C:hearts,s:0.8}红桃{s:0.8}转化为{C:abn_coin,s:0.8}币{}",
                        "{s:0.8}将手中的{C:diamonds,s:0.8}方块{s:0.8}转化为{C:abn_baton,s:0.8}杖{}",
                        "{s:0.8}将手中的{C:clubs,s:0.8}梅花{s:0.8}转化为{C:abn_chalice,s:0.8}圣杯{}",
                        "{s:0.8}将手中的{C:spades,s:0.8}黑桃{s:0.8}转化为{C:abn_sword,s:0.8}剑{}",
                    },
                    {
                        "将所有{C:attention}改变花色{}的牌",
                        "增强为{C:dark_edition}闪箔{}{C:attention}奖励{}牌",
                    }
                }
            },
            c_abn_apk = {
                name = ".APK",
                text = {
                    "将手牌中所有{C:attention}数字牌{}",
                    "增强为{C:dark_edition}闪箔{}{C:attention}水星牌{}",
                }
            },
            c_abn_zip = {
                name = ".ZIP",
                text = {
                    "将手牌中所有{C:attention}2{}、{C:attention}3{}、{C:attention}4{}",
                    "和{C:attention}5{}增强为",
                    "{C:dark_edition}镭射{}{C:attention}倍率牌{}",
                }
            },
            c_abn_obj = {
                name = ".OBJ",
            ...
            c_abn_lua = {
                ...
                text = {
                    {
                        "{s:0.8}将手中的{C:hearts,s:0.8}红桃{s:0.8}转化为{C:abn_florette,s:0.8}小花{}",
                        "{s:0.8}将手中的{C:diamonds,s:0.8}方块{s:0.8}转化为{C:abn_bell,s:0.8}铃{}",
                        "{s:0.8}将手中的{C:clubs,s:0.8}梅花{s:0.8}转化为{C:abn_leaf,s:0.8}叶{}",
                        "{s:0.8}将手中的{C:spades,s:0.8}黑桃{s:0.8}转化为{C:abn_acorn,s:0.8}橡果{}",
                    },
                    {
                        "将所有{C:attention}改变花色{}的牌",
                        "增强为{C:dark_edition}复古{}{C:attention}奖励{}牌",
                    }
                }
            },
            c_abn_pdf = {
                ...
                text = {
                    {
                        "{s:0.8}将手中的{C:hearts,s:0.8}红桃{s:0.8}转化为{C:abn_snow,s:0.8}雪{}",
                        "{s:0.8}将手中的{C:diamonds,s:0.8}方块{s:0.8}转化为{C:abn_penumbra,s:0.8}半影{}",
                        "{s:0.8}将手中的{C:clubs,s:0.8}梅花{s:0.8}转化为{C:abn_tie,s:0.8}和{}",
                        "{s:0.8}将手中的{C:spades,s:0.8}黑桃{s:0.8}转化为{C:abn_bow,s:0.8}弓{}",
                    },
                    {
                        "将所有{C:attention}改变花色{}的牌",
                        "增强为{C:dark_edition}闪箔{}{C:attention}倍率{}牌",
                    }
                }
            },
            c_abn_jpg = {
                ...
                text = {
                    ...
                    },
                    {
                        ...
                        "{C:abn_tie}和{}、{C:abn_bow}弓{}和{C:abn_penumbra}半影{}获得",
                        "{C:chips}+#1#{}筹码和{C:mult}+#2#{}倍率",
                    },
                }
            },
            c_abn_gif = {
                ...
                text = {
                    {
                        "{C:mult}削弱{}所有{C:spades}黑桃{}、{C:clubs}梅花{}",
                        "{C:abn_snow}雪{}、{C:abn_tie}和{}、",
        ...
        Tag = {
            ...
            tag_abn_hazard_negative = {
                name = "负片险兆",
                text = {
                    "给{C:attention}1{}张小丑牌和",
                    "牌组中{C:attention}#1#{}张牌",
            ...
            tag_abn_hazard_investment = {
                name = "投资险兆",
                text = {
                    "击败下一个{C:attention}Boss盲注{}后获得{C:money}$#1#{}",
                }
            },
            tag_abn_hazard_voucher = {
                name = "优惠券险兆",
                text = {
                    "下一个商店中添加{C:attention}#1#{}张优惠券",
                }
            },
            tag_abn_hazard_reroll = {
                name = "重掷险兆",
                text = {
                    "重掷下一个{C:attention}Boss盲注{} {C:attention}2{}次",
                }
            },
            tag_abn_hazard_standard = {
                name = "标准险兆",
                text = {
                    "获得{C:attention}2{}个免费的",
                    "{C:attention}超级标准包{}",
                }
            },
            ...
            tag_abn_hazard_orbital = {
                name = "轨道险兆",
                text = {
                    "将{C:attention}#1#{}和{C:attention}#2#{}",
                    "提升{C:attention}#3#{}级",
                }
            },
            ...
            tag_abn_virus = {
                ...
                text = {
                    "下一个商店中",
                    "有一张免费的{C:abn_black_seal}病毒{}小丑牌",
                },
            },
            --#endregion
        },
        Blind = {
            ...
            bl_abn_deductible_delirium = {
                name = "可抵扣谵妄", -- 此翻译不佳，但是暂时没有找到更贴切中文词汇
                text = {
                    "所有A都被削弱",
                    "三条不会计分",
                }
            ...
            bl_abn_murex_antisigma = {
                -- 其中 Murex 指骨螺属（一种海螺），Antisigma 指反西格玛（古希腊语中的一种符号或变体字母）
                name = "反Ↄ骨螺",
                text = {
                    "点数高于5的牌被削弱",
                },
        ...
        Joker = {
            ...
            j_abn_slippery_joker = {
                name = "滑溜小丑",
                text = {
                    "当{C:weather_report}天气预报{}牌未触发而自毁时",
                    "获得{C:money}$#1#{}",
                    "当{C:weather_report}天气预报{}牌触发时",
                    "这张小丑牌获得{C:money}$#2#{}售价",
                }
            },
            j_abn_joker_stamp = {
                name = "小丑印章",
                text = {
                    "{C:continent}大陆{}牌可能出现在",
                    "任何{C:attention}补充包{}中",
                }
            },
            ...
            j_abn_underblackcloudz = {
                name = "乌云之下",
                text = {
                    "重新触发所有{C:weather_report}天气预报{}效果",
                    "当{C:weather_report}天气预报{}效果{C:attention}触发{}时",
                    "这张小丑牌获得{C:chips}+#4#{}筹码和{C:mult}+#2#{}倍率",
                    "{C:inactive}（当前为{C:chips}+#3#{C:inactive}筹码，{C:mult}+#1#{C:inactive}倍率）",
                }
            },
            ...
            j_abn_blackmore_joker = {
                ...
                text = {
                    "第一张打出的牌",
                    "计分时给予其",
                    "{C:attention}点数{}作为{X:mult,C:white}倍乘倍率{}",
                }
            },
            j_abn_feste = {
                name = "费斯特",
            ...
            j_abn_slot_machine = {
                ...
                text = {
                    {
                        "列出的{C:green,E:1,S:1.1}概率{}总是",
                        "{C:green}成功{}，但每次花费{C:money}$5{}",
            ...
            j_abn_scantron_joker = {
                name = "阅卷机小丑",
                text = {
                    "计分的{C:attention}幸运{}牌给予{X:chips,C:white}^#1#{}筹码",
                    "计分的{C:attention}奖励{}牌给予{X:mult,C:white}^#2#{}倍率",
                    "计分的{C:attention}黄金{}牌给予{X:chips,C:white}^#3#{}筹码",
                    "计分的{C:attention}万能{}牌给予{X:mult,C:white}^#4#{}倍率",
                }
            },
            j_abn_fractured_identity_joker = {
                name = "破碎身份小丑",
                text = {
                    "计分的{C:mult}倍率{}牌给予{X:chips,C:white}^#1#{}筹码",
                    "计分的{C:attention}玻璃{}牌给予{X:mult,C:white}^#2#{}倍率",
                    "计分的{C:attention}钢铁{}牌给予{X:chips,C:white}^#3#{}筹码",
                    "计分的{C:attention}石头{}牌给予{X:mult,C:white}^#4#{}倍率",
                }
            },
            ...
            j_abn_boulevard_of_alters = {
                ...
                text = {
                    {
                        "每当{C:rare}稀有{}小丑牌触发",
                        "所有{C:common}普通{}小丑牌获得{C:chips}+10{}筹码",
                    },
                    {
                        "每当{C:uncommon}罕见{}小丑牌触发",
                        "所有{C:rare}稀有{}小丑牌获得{X:mult,C:white}x0.1{}倍率",
                    },
                    {
                        "每当{C:common}普通{}小丑牌触发",
                        "所有{C:uncommon}罕见{}小丑牌获得{X:chips,C:white}x0.1{}筹码",
                    },
                }
            },
        ...
        Spectral = {
            c_abn_promotion = {
                name = "晋升",
                text = {
                    "将手中的{C:attention}J{}转化为{C:attention}11{}",
                    "将手中的{C:attention}Q{}转化为{C:attention}12{}",
                    "将手中的{C:attention}K{}转化为{C:attention}13{}",
                    "将手中的{C:attention}A{}转化为{C:attention}14{}",
                }
            },
            c_abn_brand = {
                name = "烙印",
                text = {
                    "{C:red}摧毁{}所有带有{C:attention}贴纸{}的{C:attention}小丑牌{}",
                    "兑换{C:attention}2{}张随机{C:attention}优惠券{}",
                    "并创建{C:attention}2{}张随机",
                    "{C:dark_edition}负片{} {C:tarot}塔罗{}牌",
                }
            },
            c_abn_apotheosis = {
                name = "神化",
                text = {
                    "{C:red}献祭{} {C:attention}1{}张{C:dark_edition}负片{}小丑牌",
                    "给手牌中所有牌赋予随机",
            ...
            c_abn_paradigm = {
                name = "范式",
                text = {
                    "{C:red}献祭{} {C:attention}1{}张{C:dark_edition}多彩{}小丑牌",
                    "给手牌中所有牌赋予随机",
                    "{C:dark_edition}版本{}和{C:attention}蜡封{}",
                }
            },
            c_abn_super_id = {
                name = "超级身份",
                text = {
                    "给手牌中{C:attention}#1#{}张选定牌",
                    "添加{C:dark_edition}亮光{}、{C:dark_edition}虹彩{}",
                    "或{C:dark_edition}珠光{}效果",
                },
            },
            c_abn_distortion = {
                name = "扭曲",
                text = {
                    "给随机{C:attention}小丑牌{}添加{C:dark_edition}珠光{}效果",
                    "摧毁所有其他小丑牌",
                },
            },
            c_abn_presque_vu = {
                -- Presque vu 是法语
                -- 字面意思是“差不多看到”或“几乎见过”
                -- 在心理学中，它通常指你明明知道某个词语、名字或概念，但那一刻就是想不起来，感觉它就在脑海边缘。
                name = "似曾相识",
                text = {
                    "给手牌中{C:attention}#1#{}张选定牌",
            ...
            c_abn_deja_vecu = {
                -- Déjà vécu 法语直译为“已经经历过的”。
                -- 它是“既视感”（Déjà vu）的一种更深、更具体的细分体验。
                name = "已历感",
                text = {
                    "创建本赛局中",
                    "上一次使用的",
                    "{C:spectral}幻灵{}牌",
                    "{s:0.8,C:spectral}灵魂{s:0.8}除外",
                },
            },
            c_abn_deja_reve = {
                -- “Déjà rêvé”是法语
                -- 中文意思是“已经梦到过”或“似曾梦见”。
                -- 它指一种心理现象：你觉得眼前在现实中发生的某件事，自己过去在梦里曾经梦到过。
                name = "梦重现",
                text = {
                    "{C:attention}复制{}你{C:attention}完整牌组{}中的所有牌",
                    "获得{C:attention}#1#{}张随机{C:abn_hazard}险兆标签{}",
                },
            },
            c_abn_whitehole = {
                name = "白洞",
                text = {
                    "所有{C:planet,E:1}星球{C:attention,E:1}点数{}",
                    "提升{C:attention}1{}级",
                },
            },
            ...
            c_abn_mind = {
                ...
                text = {
                    "创建一张",
                    "{C:legendary,E:1}爆闪{}小丑牌",
                    "{C:inactive}（必须有空位）",
                }
            },

            c_abn_baphomet = {
                -- Baphomet是基督教传说中的知名恶魔，形象通常是长着羊头、有人类身躯和翅膀的神秘生物，常被视为撒旦的象征之一
                name = "巴弗灭",
                text = {
                    "为你的{C:attention}最常用{}牌型",
                    "创建一张{C:sigils}符印{}牌",
                }
            },
            ...
            c_abn_ultra_ego = {
                -- “超自我”或“极意·贝吉塔”，
                -- 它是动漫《龙珠超》中贝吉塔掌握的超越自我、与破坏神同源的全新形态（对应孙悟空的 Ultra Instinct“自在极意功”）。
                -- 在日文原版中，该形态被称为“我儘の極意”（意为随心所欲、任性妄为的极意）。
                name = "超自我",
                text = {
                    "{C:attention}+1{}个补充包槽位",
                    "所有{C:attention}小丑牌{}和",
                    "{C:attention}完整牌组{}中的牌",
                    "均变为{C:attention}翻转{}",
                }
            },
        },
        abn_credit_card = {
            ...
            credit_abn_coderevo = {
                ...
                text = {
                    "添加了很多东西！",
                    "包括{C:attention}优惠券{}",
                    "和{C:attention}Boss盲注{}",
                    "去玩玩 {C:purple}Revo's Vault！",
                }
            },
            credit_abn_ericthetoon = {
                ...
                text = {
                    "添加了很多东西！",
                    "去玩玩 {C:purple}Fortlatro！",
                }
            },
            credit_abn_deleteduser = {
                name = "DeletedUser",
                text = {
                    "添加了一些{C:attention}小丑牌{}",
                }
            },
            credit_abn_vega = {
                name = "Vega",
            ...
            credit_abn_inky = {
                ...
                text = {
                    "创作了大量超酷的{C:green}美术{}！",
                    "{s:0.85}（还有这些超酷的致谢卡牌）",
                    "去看看 {C:attention}Inky's Bunch-O-Things！",
                }
            },
            credit_abn_feli = {
                name = "Feli",
                text = {
                    "添加了一些{C:attention}小丑牌{}",
                    "去看看 {C:attention}Feli's Jokeria！",
                }
            },
            credit_abn_j8bit = {
                name = "J8bit",
            ...
            credit_abn_rkart = {
                ...
                text = {
                    "创作了一些{C:red}音乐{}",
                    "包括{C:attention}主菜单{}",
                    "{C:attention}Boss盲注{}、{C:attention}小丑牌{}",
                    "和{C:attention}补充包{}主题！",
                }
            },
            credit_abn_firch = {
                name = "Firch",
        ...
        Other = {
            ...
            abn_ultra_ego_info = {
                ...
                text = {
                    "一局中只能使用",
                    "{C:attention}4{}次",
                    "{C:inactive}（当前为{C:attention}#1#{C:inactive}/4）",
                }
            },
            ...
            p_abn_weather_normal = {
                ...
                text = {
                    "从最多{C:attention}#2#{}张",
                    "{C:weather_report}天气预报{}牌中选择{C:attention}#1#{}张",
                }
            },
            p_abn_weather_jumbo = {
                name = "巨型预报包",
            ...
            p_abn_lexica_normal = {
                ...
                text = {
                    "从最多{C:attention}#2#{}张",
                    "{C:lexica}辞典{}牌中选择{C:attention}#1#{}张",
                }
            },
            p_abn_lexica_jumbo = {
                name = "巨型辞典包",
            ...
            p_abn_continent_mega = {
                ...
                text = {
                    "从最多{C:attention}#2#{}张",
                    "{C:continent}大陆{}牌中选择{C:attention}#1#{}张",
                }
            },
            ...
            p_abn_calligraphy_normal = {
                ...
                text = {
                    "从最多{C:attention}#2#{}张",
                    "{C:calligraphy}书法{}牌中选择{C:attention}#1#{}张",
                    "即选即用",
                },
            },
            ...
            p_abn_glyph_normal = {
                ...
                text = {
                    "从最多{C:attention}#2#{}张",
                    "{C:glyphs}符文{}牌中选择{C:attention}#1#{}张",
                    "即选即用",
                },
            },
            p_abn_glyph_jumbo = {
            ...
            abn_duality_seal = {
                name = "二元蜡封",
                text = {
                    "每{C:attention}持有{}一张{C:abn_duality_seal}二元蜡封{}牌",
                    "此牌永久获得{C:chips}+#1#{}筹码和{C:mult}+#2#{}倍率",
                }
            },
            abn_rainbow_seal = {
                name = "彩虹蜡封",
            ...
            abn_brass_seal = {
                ...
                text = {
                    "计分时重新触发",
                    "{C:attention}右侧{}的{C:attention}游戏牌{}",
                }
            },
            abn_lavender_seal = {
                name = "薰衣草蜡封",
                text = {
                    "计分时重新触发",
                    "{C:attention}左侧{}的{C:attention}游戏牌{}",
                }
            },
            abn_violet_seal = {
                name = "紫色蜡封",
            ...
            abn_teal_seal = {
                ...
                text = {
                    "回合结束时",
                    "如果{C:attention}留在手牌{}中",
                    "创建一张{C:abn_calamity}灾厄{}牌",
                    "{C:inactive}（必须有空位）",
                }
            },
            abn_black_seal = {
            ...
            abn_orange_seal = {
                ...
                text = {
                    "回合结束时",
                    "如果{C:attention}留在手牌{}中",
                    "创建此牌{C:attention}点数{}的{C:planet}星球{}牌",
                    "{C:inactive}（必须有空位）",
                }
            },
            abn_pink_seal = {
            ...
            p_abn_calamity_normal = {
                ...
                text = {
                    "从最多{C:attention}#2#{}张",
                    "{C:abn_calamity}灾厄{}牌中选择{C:attention}#1#{}张",
                    "即选即用",
                }
            },
            ...
            p_abn_sigil_normal = {
                ...
                text = {
                    "从{C:attention}#2#{}张",
                    "{C:sigils}符印{}牌中选择{C:attention}#1#{}张",
                    "即选即用",
                    "{C:inactive}（不能跳过）",
                }
            },
            ...
            p_abn_astro_normal = {
                ...
                text = {
                    "从最多{C:attention}#2#{}张",
                    "{C:astro_cards}星座{}牌中选择{C:attention}#1#{}张",
                    "即选即用",
                }
            },
            p_abn_astro_jumbo = {
            ...
            p_abn_program_normal = {
                ...
                text = {
                    "从最多{C:attention}#2#{}张",
                    "{C:program_pack}程序{}牌中选择{C:attention}#1#{}张",
                    "即选即用",
                }
            },
            p_abn_program_jumbo = {
            ...
            abn_credits = {
                text = {
                    "{C:green,s:1.5}美术{s:1.5}由Balatro {C:blue,s:1.5}Discord{s:1.5}的伙伴们创作！",
                    "{C:inactive,s:1.3}（看看小丑牌下面的署名 :>）",
                }
            },
        },
        Mod = {
            abandonia = {
                -- Abandon 意为抛弃、遗弃；-ia 通常用于构成某种地方或领域的名称（如 Romania 罗马尼亚）。
                name = "Abandonia",
                text = {
                    "欢迎来到{C:attention}Abandonia{}！",
                    "一个庆祝众多创意",
                    "{C:blue}点子{}和{C:green}作品集{}的小丑牌模组！！",
                    " ",
                    " ",
                    "由{C:dark_edition}Bunnet{}倾情打造！",
                }
            },
        },
        Edition = {
            ...
            e_abn_chromatic = {
                ...
                text = {
                    "触发时获得",
                    "{C:white,X:chips}X#1#{}筹码、{C:white,X:mult}X#2#{}倍率",
                    "和{C:money}$#3#{}",
                }
            },
            e_abn_reversal = {
            ...
            e_abn_vintage = {
                ...
                text = {
                    "打出的牌型每升一级",
                    "获得{C:money}+$#3#{}、{C:chips}+#2#{}筹码和{C:mult}+#1#{}倍率",
                }
            },
            e_abn_bright = {
                name = "明亮",
        ...
        Tarot = {
            ...
            c_abn_crown = {
                name = "王冠",
                text = {
                    "选定{C:attention}1{}张{C:attention}数字牌{}",
                    "{C:red}摧毁{}所有手牌中的{C:attention}人头牌{}",
                    "选定牌获得被摧毁牌",
                    "{C:attention}点数{}总和的{C:chips}筹码{}",
                }
            },
            c_abn_eon = {
                name = "永世",
                text = {
                    "给{C:attention}最右侧{}的小丑牌",
                    "添加{C:attention}不朽{}效果",
                    "{C:attention}最左侧{}的小丑牌",
                    "获得随机{C:abn_perishable}贴纸{}",
                }
            },
            c_abn_snowflake = {
                name = "雪花",
            ...
            c_abn_crossroad = {
                ...
                text = {
                    "将{C:attention}#1#{}张",
                    "选定牌增强为",
                    "{C:spades}暗色{}或{C:diamonds}光明{}牌",
                    "{s:0.8}基于牌的{C:attention,s:0.8}花色{}",
                },
            },
        },
        calamity_cards = {
            c_abn_eruption = {
                ...
                text = {
                    {
                        "从{C:attention}所有牌{}中移除",
                        "{C:attention}石头{}和{C:attention}钢铁{}增强效果",
                    },
                    {
                        "受影响的牌每张获得",
                        "{C:chips}+#1#{}筹码",
            ...
            c_abn_tsunami = {
                ...
                text = {
                    {
                        "从{C:attention}所有牌{}中移除",
                        "{C:attention}油田火{}和{C:attention}石油{}增强效果",
                    },
                    {
                        "受影响的牌每张获得",
                        "{C:white,X:mult}X#1#{}倍率",
            ...
            c_abn_cyclone = {
                ...
                text = {
                    {
                        "从{C:attention}所有牌{}中移除",
                        "{C:attention}玻璃{}和{C:attention}水星{}增强效果",
                    },
                    {
                        "受影响的牌每张获得",
                        "{C:white,X:chips}X#1#{}筹码",
            ...
            c_abn_flood = {
                ...
                text = {
                    {
                        "从{C:attention}所有牌{}中移除",
                        "{C:attention}烙铁{}和{C:attention}万能{}增强效果",
                    },
                    {
                        "受影响的牌每张获得",
            ...
            c_abn_tornado = {
                ...
                text = {
                    {
                        "从{C:attention}所有牌{}中移除",
                        "{C:attention}倍率{}和{C:attention}奖励{}增强效果",
                    },
                    {
                        "受影响的牌每张获得",
                        "{C:mult}+#1#{}倍率和{C:chips}+#2#{}筹码",
            ...
            c_abn_tremor = {
                ...
                text = {
                    {
                        "从{C:attention}所有牌{}中移除",
                        "{C:attention}黄金{}和{C:attention}茶渍{}增强效果",
                    },
                    {
                        "受影响的牌每张获得",
                        "{C:money}$#1#{}和{C:mult}+#2#{}倍率",
            ...
            c_abn_wildfire = {
                ...
                text = {
                    {
                        "从{C:attention}所有牌{}中移除",
                        "{C:attention}幸运{}和{C:attention}海洋{}增强效果",
                    },
                    {
                        "受影响的牌每张获得",
                        "{C:money}+#1#{}晋升强度",
            ...
            c_abn_avalanche = {
                ...
                text = {
                    {
                        "摧毁所有{C:attention}持有{}的{C:attention}消耗牌{}",
                        "{C:inactive}（最多40张）",
                    },
                    {
                        "{C:attention}完整牌组{}中所有牌",
                        "每张{C:attention}消耗牌{}被摧毁时",
                        "获得{C:money}$#1#{}、{C:mult}+#2#{}倍率和{C:chips}+#3#{}筹码",
                        "{C:inactive}（将获得{C:money}$#4#{C:inactive}、{C:mult}+#5#{C:inactive}、{C:chips}+#6#{C:inactive}）",
                    }
                }
            },
            c_abn_blizzard = {
                ...
                text = {
                    {
                        "摧毁{C:attention}完整牌组{}中",
                        "所有{C:attention}人头牌{}",
                    },
                    {
                        "每张{C:attention}人头牌{}被摧毁时",
                        "所有小丑牌获得{C:mult}+#1#{}倍率和{C:chips}+#2#{}筹码",
                        "{C:inactive}（将获得{C:mult}+#3#{C:inactive}、{C:chips}+#4#{C:inactive}）",
                    }
                }
            },
            ...
            c_abn_drought = {
                ...
                text = {
                    ...
                    {
                        "{C:attention}完整牌组{}中所有牌",
                        "每张获得{C:mult}+#1#{}倍率和{C:chips}+#2#{}筹码",
                    }
                }
            },
            c_abn_heatwave = {
                ...
                text = {
                    {
                        "摧毁与选定牌相同",
                        "{C:attention}花色{}的所有牌",
                        "{C:attention,s:0.8}万能牌{s:0.8}除外",
                    },
                    {
                        "{C:attention}完整牌组{}中所有牌",
                        "每张获得{C:mult}+#1#{}倍率和{C:chips}+#2#{}筹码",
            ...
            c_abn_fire_swirl = {
                ...
                text = {
                    {
                        "从{C:attention}所有牌{}中移除",
                        "{C:attention}波尔卡点{}和{C:attention}红外{}增强效果",
                    },
                    {
                        "受影响的牌每张获得",
                        "其{C:attention}点数{}作为{C:mult}倍率{}",
                    }
                }
            },
            c_abn_cas_crater = {
                ...
                text = {
                    {
                        "从{C:attention}所有牌{}中移除",
                        "{C:attention}缝制{}和{C:attention}棉质{}增强效果",
                    },
                    {
                        "受影响的牌每张获得",
                        "{C:mult}+#2#{}倍率和{C:money}+#1#{}晋升强度",
                    }
                }
            },
            c_abn_minefire = {
                ...
                text = {
                    {
                        "从{C:attention}所有牌{}中移除",
                        "{C:attention}禅{}和{C:attention}金缮{}增强效果",
                    },
                    {
                        "受影响的牌每张获得",
                        "{C:mult}+#1#{}倍率和{C:attention}+#2#{}次重新触发",
                    }
                }
            },
            c_abn_mudslide = {
                ...
                text = {
                    {
                        "摧毁{C:attention}完整牌组{}中",
                        "所有点数高于{C:attention}9{}的牌",
                    },
                    {
                        "提升{C:attention}完整牌组{}中",
                        "所有{C:attention}点数{}的{C:planet}星球{} {C:attention}点数{}等级{C:attention}#1#{}级",
                    }
                }
            },
            c_abn_sinkhole = {
                ...
                text = {
                    {
                        "将{C:attention}完整牌组{}中",
                        "所有{C:attention}点数{}的{C:planet}星球{} {C:attention}点数{}等级{C:red}降低{C:attention}#5#{}级",
                    },
                    {
                        "受影响的牌每失去{C:attention}1{}级",
                        "获得{C:money}$#1#{}和{C:gold}+#2#{}晋升强度",
                        "{C:inactive}（将获得{C:money}$#3#{C:inactive}、{C:gold}+#4#{C:inactive}）",
                    }
                }
            },
            c_abn_big_rip = {
                ...
                text = {
                    {
                        "所有{E:2,C:purple}牌型{}的",
                        "晋升强度提升{C:gold}2{}",
                    },
                    {
                        "所有小丑牌变为{C:attention}易碎{}",
                        "和{C:attention}租用{}",
                    },
                }
            },
        ...
        nightshift_cards = {
            c_abn_furtive = {
                name = "鬼祟",
                text = {
                    "创建一张{C:dark_edition}负片{}",
                    "{C:legendary}传奇{} {C:attention}翻转{}小丑牌",
                }
            },
            c_abn_intrusion = {
                name = "侵入",
                text = {
                    "所有小丑牌变为{C:attention}翻转{}",
                    "并获得{C:chips}+#1#{}筹码和{C:mult}+#2#{}倍率",
                }
            },
            c_abn_apparition = {
                name = "幻影",
                text = {
                    "用{C:spectral}幻灵{}牌填满消耗牌槽位",
                    "有{C:green}#1#/#2#{}几率",
                    "获得{C:attention}+1{}个小丑牌槽位",
                }
            },
            c_abn_smirk = {
                name = "假笑",
                text = {
                    "创建一张带有{C:abn_eternal}永恒{}、{C:purple}容器{}、",
                    "{C:dark_edition}幽冥{}的{C:attention}喜剧演员{}小丑牌",
                    "{C:inactive}（必须有空位）",
                }
            },
            c_abn_observer = {
                ...
                text = {
                    {
                        "将所有{C:attention}背面朝上{}的牌",
                        "和小丑牌翻至{C:attention}正面朝上{}",
                    },
                    {
                        "{C:red}移除{}所有贴纸",
                    },
            ...
            c_abn_tunnel = {
                ...
                text = {
                    {
                        "{C:attention}完整牌组{}中所有{C:attention}点数{}的",
                        "{C:attention}‘点数’{}{C:planet}星球{}牌的升级效果提升{C:attention}#1#{}级",
                    },
                    {
                        "将{C:attention}最常用{}牌型",
                        "降至{C:attention}1{}级",
                    },
                }
            },
            ...
            c_abn_hostile = {
                ...
                text = {
                    {
                        "给所有非{C:abn_plagued}瘟疫缠身{}的小丑牌",
                        "添加{C:mult}易碎{}和{C:money}租用{}效果",
                    },
                    {
                        "创建一张随机",
        ...
        astro_cards = {
            c_abn_aquar = {
                ...
                text = {
                    "有{C:green}#1#/#2#{}几率",
                    "重新触发{C:attention}下一张{} {C:planet}星球{}牌",
                }
            },
            c_abn_aries = {
                name = "白羊",
            ...
            c_abn_capri = {
                ...
                text = {
                    "有{C:green}#1#/#2#{}几率",
                    "给所有{C:attention}小丑牌{}添加{C:chips}+#3#{}筹码",
                }
            },
            c_abn_gemini = {
                name = "双子",
            ...
            c_abn_libra = {
                ...
                text = {
                    "有{C:green}#1#/#2#{}几率",
                    "给{C:attention}完整牌组{}中所有牌",
                    "添加{C:chips}+#3#{}筹码和{C:mult}+#4#{}倍率",
                }
            },
            c_abn_pisces = {
                name = "双鱼",
            ...
            c_abn_scorpio = {
                ...
                text = {
                    "有{C:green}#1#/#2#{}几率",
                    "创建所有{C:attention}持有{}消耗牌的",
                    "{C:dark_edition}负片{}复制牌",
                }
            },
            c_abn_taurus = {
                name = "金牛",
                text = {
                    "有{C:green}#1#/#2#{}几率",
                    "兑换{C:attention}#3#{}张随机{C:attention}优惠券{}",
                }
            },
            c_abn_virgo = {
                name = "处女",
                text = {
                    "有{C:green}#1#/#2#{}几率",
                    "创建一张{C:dark_edition}负片{} {C:attention}黑洞{}牌",
                }
            },
            c_abn_serpentarius = {
                name = "蛇夫",
        ...
        Voucher = {
            ...
            v_abn_illusion_master = {
                ...
                text = {
                    ...
                    "必定带有{C:dark_edition}版本{}和{C:attention}蜡封{}",
                    "或{C:dark_edition}版本{}和{C:attention}增强效果{}",
                }
            },
            v_abn_forget_fossil = {
                name = "遗忘化石",
            ...
            v_abn_chaos = {
                name = "混沌之摆",
                text = {
                    "{C:sigils}符印{}、{C:astro_cards}星座{}、{C:solid_state}固态{}",
                    "{C:nightshift_cards}夜班{}、{C:calamity_cards}灾厄{}和{C:lexica}辞典{}牌",
                    "可能出现在任何",
                    "{C:attention}秘术包{}中",
                }
            },
            v_abn_invasion = {
                name = "平行入侵",
                text = {
                    "{C:sigils}符印{}、{C:astro_cards}星座{}",
                    "{C:solid_state}固态{}、{C:nightshift_cards}夜班{}",
        ...
        Stake = {
            stake_abn_honor = {
                name = "荣誉金宝",
                text = {
                    "在底注{C:attention}9{}通关",
                    "底注{C:attention}4{}、{C:attention}8{}和{C:attention}9{}为{C:abn_hazard}险兆盲注{}",
                },
            },
            stake_abn_menacing = {
                name = "威胁金宝",
                text = {
                    "在底注{C:attention}10{}通关",
                    "底注{C:attention}5{}和{C:attention}10{}为{C:abn_hazard}险兆盲注{}",
                },
            },
            stake_abn_toxic = {
                name = "剧毒金宝",
                text = {
                    "在底注{C:attention}11{}通关",
                    "{s:0.8,C:attention}小丑牌{s:0.8}可以被{C:attention,s:0.8}翻转{}",
                    "{s:0.8,C:attention}小丑牌{s:0.8}可以带有{C:attention,s:0.8}贴纸{}",
                    "底注{C:attention}6{}和{C:attention}11{}为{C:abn_hazard}险兆盲注{}",
                },
            },
            stake_abn_noxious = {
                name = "有害金宝",
                text = {
                    "在底注{C:attention}12{}通关",
                    "{s:0.8}应用{C:attention,s:0.8}剧毒金宝{}的规则",
                },
            },
            stake_abn_lethal = {
                name = "致命金宝",
                text = {
                    "在底注{C:attention}13{}通关",
                    "{s:0.8}应用{C:attention,s:0.8}剧毒金宝{}的规则",
                },
            },
            stake_abn_baneful = {
    ...
    misc = {
        ...
        dictionary = {
            ...
            -- 小丑牌永久加成
            abn_perma_bonus = "{C:chips}+#1#{}额外筹码",
            abn_perma_mult = "{C:mult}+#2#{}额外倍率",
            abn_perma_xmult = "{C:white,X:mult}X#3#{}倍率",
            ...
            ph_abn_no_sigils_active = "未激活符印",

            -- 配置选项
            k_abn_config_show_credits = "制作人员名单",
            abn_show_credits = "启用后会在模组徽章下方显示制作人员名单",

            k_abn_config_toggle_music = "切换音乐",
            ...
            k_abn_rankless = "无点数",
            k_abn_numbered = "数字牌",
            abn_calamitybooster = "灾厄包",
            abn_calamitybooster_j = "巨型灾厄包",
            abn_calamitybooster_m = "超级灾厄包",
            abn_sigilbooster = "符印包",
            abn_astrobooster = "星座包",
            k_solid_pack = "固态包",
            abn_glyphbooster = "符文包",
            abn_programbooster = "程序包",
            k_abn_increased = "提升！",
            b_abn_ranks = "点数",
            k_abn_merged = "已合并！",
            k_abn_holo = "镭射！",
            k_abn_plus_nightshift = "+1夜班牌",
            k_abn_plus_astro = "+1星座牌",
            k_abn_plus_sigil = "+1符印牌",
            k_abn_plus_calamity = "+1灾厄牌",
            k_abn_plus_weather = "+1天气预报牌",
            k_abn_plus_program = "+1程序牌",
            ...
            -- 消耗牌类型
            b_weather_report_cards = "天气预报牌",
            k_weather_report = "天气预报",

            b_calamity_cards_cards = "灾厄牌",
            k_calamity_cards = "灾厄",

            b_astro_cards_cards = "星座牌",
            k_astro_cards = "星座",
            ...
            b_nightshift_cards_cards = "夜班牌",
            k_nightshift_cards = "夜班",

            b_program_pack_cards = "程序牌",
            k_program_pack = "程序",
            ...
            b_continent_cards = "大陆牌",
            k_continent = "大陆",

            b_solid_state_cards = "固态牌",
            k_solid_state = "固态",
        ...
        labels = {
            ...
            abn_white_seal = "白色蜡封",
            abn_brown_seal = "棕色蜡封",
            abn_violet_seal = "紫色蜡封",
            abn_lavender_seal = "薰衣草蜡封",
            abn_skyblue_seal = "天蓝蜡封",
            abn_oxidized_seal = "氧化蜡封",
            abn_brass_seal = "黄铜蜡封",
            abn_copper_seal = "铜色蜡封",
            abn_silver_seal = "银色蜡封",
            abn_linguistic_seal = "语言学蜡封",
            abn_rubicund_seal = "红润蜡封",
            abn_brine_seal = "盐水蜡封",
        ...
        poker_hands = {
            ['abn_Spectrum'] = "光谱",
            ['abn_Straight Spectrum'] = "顺子光谱",
            ['abn_Straight Spectrum (Royal)'] = "皇家光谱",
            ['abn_Spectrum House'] = "光谱葫芦",
            ['abn_Spectrum Five'] = "光谱五条",
            ['abn_Spectrum Six'] = "光谱六条",

            ["abn_Specflush"] = "光谱同花",
            ["abn_Specflush Five"] = "光谱同花五条",
            ["abn_Specflush Six"] = "光谱同花六条",
            ["abn_Straight Specflush_2"] = "皇家光谱同花",
            ["abn_Specflush House"] = "光谱同花葫芦",
            ["abn_Straight Specflush"] = "顺子光谱同花",

            ["abn_triple_pair"] = "三对",
            ["abn_double_triple"] = "双三条",
            ["abn_6oak"] = "六条",
            ["abn_Flush Six"] = "同花六条",

            ['abn_Abyss'] = "深渊",
            ['abn_Empty Throne'] = "空王座",
            ['abn_Empty Throne (Royal)'] = "皇家王座",
            ['abn_Void Space'] = "虚空",

            ['abn_Inverse Spectrum'] = "逆光谱",
            ['abn_Divider Conquered'] = "分界征服",
            ['abn_Twilight Distillation'] = "暮光精馏",

            ['abn_Haunted Mansion'] = "鬼宅",
            ['abn_Mansion'] = "大宅",
