    ...
    descriptions = {
        Back = {
            b_pl_sponsored = {
                ...
                text = {
                    "开局时拥有",
                    "{C:attention,T:v_pl_ad_break}广告时段{}，",
                    "{C:attention}-1{}个商店槽位"
                }
            },
        },
        ...
        Joker = {
            ...
            j_pl_el_dorado = {
                ...
                text = {
                    "回合结束时，",
                    "牌组中每张{C:attention}万能牌{}可赚取{C:money}$#1#{}",
            ...
            j_pl_raw_meat = {
                ...
                text = {
                    ...
                    "出售此小丑牌{C:attention}#1#{C:attention}底注",
                    "{C:inactive}(#2#)"
                }
            },
            j_pl_croissant = {
            ...
            j_pl_odd_sock = {
                name = "奇袜",
                text = {
                    "若{C:attention}被弃掉的手牌{}中没有{C:attention}对子{}，",
                    "则获得{C:chips}+#1#{}筹码",
                    "{C:inactive}（当前为{C:chips}+#2#{C:inactive}筹码）"
                }
            },
            j_pl_hot_air_balloon = {
                ...
                text = {
                    "回合结束时获得{C:money}$#1#{}",
                    "每使用一张{C:tarot}塔罗牌{}，奖励{C:money}+$#2#{}",
            ...
            j_pl_extraterrestrial_joker = {
                ...
                text = {
                    "选择{C:attention}盲注{}时，",
                    "摧毁所有{C:attention}消耗牌{}，并",
                    "升级{C:attention}最常使用{}的牌型",
                    "{C:inactive}（当前为{C:attention}#1#{C:inactive}）"
                }
            },
        },
