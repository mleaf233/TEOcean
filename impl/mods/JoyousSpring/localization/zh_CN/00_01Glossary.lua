    ...
    descriptions = {
        Other = {
            ...
            joy_tooltip_alt_art = {
                name = "可替卡面",
                text = {
                    "按下{C:attention}A{}键以切换",
                    "不同的卡面美术",
                    "{C:inactive,s:0.8}(仅此张卡生效)"
                },
            },
            joy_tooltip_revive = {
                name = "复活",
            ...
            joy_tooltip_fusion_joker = {
                ...
                text = {
                    ...
                    "{s:0.15} ",
                    "{s:0.9}必须通过选择需要销毁的{s:0.9,C:attention}素材{s:0.9}",
                    "{s:0.9}从该区域进行特殊召唤",
                    "{s:0.9}必须以此方式召唤过才能被复活"
                },
            },
            joy_tooltip_xyz_joker = {
                ...
                text = {
                    ...
                    "{s:0.9}必须以此方式召唤过才能被复活",
                    "{s:0.15} ",
                    "{s:0.9}开始时拥有{s:0.9,C:joy_xyz}超量素材{}数量",
                    "{s:0.9}等于其召唤时使用的素材数量"
                },
            },
            ...
            joy_tooltip_ritual_joker = {
                ...
                text = {
                    "无法从商店中购买",
                    "{s:0.15} ",
                    "{s:0.9}必须从商店中通过选择需要销毁的",
                    "{s:0.9}{s:0.9,C:attention}素材{s:0.9}进行特殊召唤",
                    "{s:0.9}必须以此方式召唤过才能被复活"
                },
            },
